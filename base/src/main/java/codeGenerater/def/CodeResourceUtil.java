...
public class CodeResourceUtil
{
  ...
  public static String base_dao = "";
  public static String supervo = "";
 ...
 // public static String page_package = "page";
  ...
  static
  {
    ...
    base_dao=getBase_dao();
    base_service=getBase_service();
    supervo=getSupervo();
  ...
  public static final String getBase_dao()
  {
    return bundlePath.getString("base_dao");
  }
  public static final String getBase_service()
  {
    return bundlePath.getString("base_service");
  }
  ...
  public static final String getSupervo()
  {
    return bundlePath.getString("superVO");
  }
